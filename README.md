...
El módulo está dividido en 9 clases progresivas. Cada clase incluye su teoría en la plataforma web y su respectiva práctica en libretas de Jupyter.
...
| **3** | **Modelos Supervisados I** *Modelos lineales, Regresión Logística, Árboles de Decisión.* |  |
| **4** | **Modelos Supervisados II** *Máquinas de Vectores de Soporte (SVM) y Redes Neuronales (MLP).* |  |
